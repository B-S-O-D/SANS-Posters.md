# 8. PowerShell-Enterprise-Cloud-Compliance-Cheatsheet-v1.0.0
...
SEC557: Continuous Automation for Enterprise and

Cloud Compliance course VMs using PowerShell Core.
