# 58. Pen Test Rules of Engagement Worksheet
...
"Daily Debrieﬁng" Frequency: _____________________________________________

"Daily Debrieﬁng" Time/Location: __________________________________________
...
Does target organization's network have automatic shunning capabilities that might
disrupt access in unforeseen ways (i.e. create a denial-of-service condition), and if so,
...
If not, what steps will be taken to continue if systems get shunned and what approval (if
...
What is the policy regarding viewing data (including potentially sensitive/conﬁdential
data) on compromised hosts:
